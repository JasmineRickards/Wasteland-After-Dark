...
/datum/preferences/proc/load_preferences()
	...
	clientfps		= sanitize_integer(clientfps, 0, 1000, 40) //wasteland edit. default to 40
...
/datum/preferences/proc/load_character(slot)
	...
	features = list("mcolor" = "FFFFFF", "mcolor2" = "FFFFFF", "mcolor3" = "FFFFFF", "tail_lizard" = "Smooth",
				...
				"ooc_notes" = "", "meat_type" = "Mammalian", "body_model" = MALE, "body_size" = RESIZE_DEFAULT_SIZE,
