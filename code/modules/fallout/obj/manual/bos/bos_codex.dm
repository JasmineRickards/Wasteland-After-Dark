...
<body>
	...
	<p>Without exception, the Forced Evolutionary Virus must be handled. If someone is producing, hoarding, or utilizing FEV, it is your duty to neutralize the threat by any and all means necessary, no matter how minor. There is no room for compromise.</p>
