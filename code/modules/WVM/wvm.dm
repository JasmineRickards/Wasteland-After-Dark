...
/obj/machinery/mineral/wasteland_vendor/weapons/ncr
	name = "NCR Vending Machine - Convoy trader"
	icon_state = "weapon_idle"
	prize_list = list(
		new /datum/data/wasteland_equipment("Basic salvage",				/obj/item/salvage/low,												25),
		new /datum/data/wasteland_equipment("Advanced salvage",				/obj/item/salvage/high,												150),
		...
		new /datum/data/wasteland_equipment("Guns and Bullets, Part 3",		/obj/item/book/granter/crafting_recipe/gunsmith_three, 				600),
		new /datum/data/wasteland_equipment("Guns and Bullets, Part 4",		/obj/item/book/granter/crafting_recipe/gunsmith_four, 				1200),
		new /datum/data/wasteland_equipment("Marksman rifle blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/marksman,			400),
		new /datum/data/wasteland_equipment("Combat rifle blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/combatrifle,		400),
		new /datum/data/wasteland_equipment("Brush gun blueprint",			/obj/item/book/granter/crafting_recipe/blueprint/brushgun,			500),
		new /datum/data/wasteland_equipment("10mm SMG blueprint",			/obj/item/book/granter/crafting_recipe/blueprint/smg10mm,			400),
		new /datum/data/wasteland_equipment("R91 rifle blueprint",			/obj/item/book/granter/crafting_recipe/blueprint/r91,				1200),
		new /datum/data/wasteland_equipment("Sniper rifle blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/sniper,			1200),
		new /datum/data/wasteland_equipment("Riot shotgun blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/riotshotgun,		1400),
		...
		new /datum/data/wasteland_equipment("Reinforced combat helmet",		/obj/item/clothing/head/helmet/f13/combat/mk2/ncr,					500),
		new /datum/data/wasteland_equipment("Reinforced combat armor",		/obj/item/clothing/suit/armor/f13/combat/mk2/ncr,					1200),
...
/obj/machinery/mineral/wasteland_vendor/weapons/Legion
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Sniper rifle blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/sniper,			1200),
		new /datum/data/wasteland_equipment("Riot shotgun blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/riotshotgun,		1400),
		new /datum/data/wasteland_equipment("Reinforced combat helmet",		/obj/item/clothing/head/helmet/f13/combat/mk2 ,					500),
		new /datum/data/wasteland_equipment("Reinforced combat armor",		/obj/item/clothing/suit/armor/f13/combat/mk2,					1200),
		new /datum/data/wasteland_equipment("Scavenger pt.1",				/obj/item/book/granter/crafting_recipe/scav_one,					650),
		new /datum/data/wasteland_equipment("Scavenger pt.2",				/obj/item/book/granter/crafting_recipe/scav_two,					750),
		new /datum/data/wasteland_equipment("Scavenger pt.3",				/obj/item/book/granter/crafting_recipe/scav_three,					850)
		)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Basic salvage",				/obj/item/salvage/low,												25),
		new /datum/data/wasteland_equipment("Advanced salvage",				/obj/item/salvage/high,												150),
...
/obj/machinery/mineral/wasteland_vendor/weapons/BoS
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Salvaging book",				/obj/item/book/granter/trait/techno,								600),
		new /datum/data/wasteland_equipment("Russian primer book",			/obj/item/book/granter/trait/rifleman,								800),
		new /datum/data/wasteland_equipment("Old weapons book",				/obj/item/book/granter/crafting_recipe/ODF,							1000),
		new /datum/data/wasteland_equipment("survival knife",				/obj/item/melee/onehanded/knife/survival, 							70),
		new /datum/data/wasteland_equipment(".22 Pistol",					/obj/item/gun/ballistic/automatic/pistol/pistol22,					110),
		new /datum/data/wasteland_equipment("9mm pistol",					/obj/item/gun/ballistic/automatic/pistol/ninemil,					150),
		new /datum/data/wasteland_equipment("10mm pistol",					/obj/item/gun/ballistic/automatic/pistol/n99,						150),
		...
		new /datum/data/wasteland_equipment(".223 pistol blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/thatgun,			800),
		new /datum/data/wasteland_equipment("LSW blueprint",				/obj/item/book/granter/crafting_recipe/blueprint/lsw,				2000),
		new /datum/data/wasteland_equipment("Wattz laser pistol",				/obj/item/gun/energy/laser/wattz,								300),
		new /datum/data/wasteland_equipment("R84 blueprint",				/obj/item/book/granter/crafting_recipe/blueprint/r84,				2000),
		new /datum/data/wasteland_equipment("Desert Eagle blueprint",		/obj/item/book/granter/crafting_recipe/blueprint/deagle,			1500),
		new /datum/data/wasteland_equipment("AMR Blueprint",				/obj/item/book/granter/crafting_recipe/blueprint/am_rifle,			3200),
		new /datum/data/wasteland_equipment("Citykiller blueprint",			/obj/item/book/granter/crafting_recipe/blueprint/citykiller,		1800),
		...
		new /datum/data/wasteland_equipment("Reinforced combat helmet",		/obj/item/clothing/head/helmet/f13/combat/mk2 ,					500),
		new /datum/data/wasteland_equipment("Reinforced combat armor",		/obj/item/clothing/suit/armor/f13/combat/mk2,					1200),
		new /datum/data/wasteland_equipment("Power armor pamphlet",			/obj/item/book/granter/trait/pa_wear,								500),
		...
		new /datum/data/wasteland_equipment("Refurbished T-45d",			/obj/item/clothing/suit/armor/f13/power_armor/t45d/refurb,				2500),
		...
		new /datum/data/wasteland_equipment("Wattz 2000e",					/obj/item/gun/energy/laser/wattz2k/extended,						1500)
		)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Basic salvage",				/obj/item/salvage/low,												25),
		new /datum/data/wasteland_equipment("Advanced salvage",				/obj/item/salvage/high,												150),
