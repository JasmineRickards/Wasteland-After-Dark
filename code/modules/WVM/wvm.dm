...
/obj/machinery/mineral/wasteland_vendor/medical
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Fixer",						/obj/item/storage/pill_bottle/chem_tin/fixer,						500)
		)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Syringe",						/obj/item/reagent_containers/syringe,								10),
		new /datum/data/wasteland_equipment("Empty pillbottle",				/obj/item/storage/pill_bottle,										15),
...
/obj/machinery/mineral/wasteland_vendor/weaponsbighorn
	name = "Trader - Weapons"
	icon_state = "weapon_idle"
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Expensive gun blueprints",		/obj/effect/spawner/lootdrop/f13/blueprintHigh, 				1800),
		)
	highpop_list = list(
...
/obj/machinery/mineral/wasteland_vendor/weapons/ncr
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Guns and Bullets, Part 4",		/obj/item/book/granter/crafting_recipe/gunsmith_four, 				1200),
		new /datum/data/wasteland_equipment("Russian primer book", 			/obj/item/book/granter/trait/rifleman, 								800),
		new /datum/data/wasteland_equipment("Reinforced combat helmet",		/obj/item/clothing/head/helmet/f13/combat/mk2/ncr,					200),
		new /datum/data/wasteland_equipment("Reinforced combat armor",		/obj/item/clothing/suit/armor/f13/combat/mk2/ncr,					600),
