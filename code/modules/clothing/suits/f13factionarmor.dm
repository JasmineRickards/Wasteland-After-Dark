...
/obj/item/clothing/suit/armor/f13/raider
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 35, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 10)
	strip_delay = 40
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/raider/supafly //melee spec
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 10)
	slowdown = 0.01
	icon_state = "supafly"
	item_state = "supafly"
...
/obj/item/clothing/suit/armor/f13/raider/blastmaster
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 50, "bio" = 0, "bomb" = 90, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 10)
	flash_protect = 2
...
/obj/item/clothing/suit/armor/f13/raider/badlands
	...
	icon_state = "badlands"
	item_state = "badlands"
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/raider/painspike
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 40, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/raider/iconoclast
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "bio" = 0, "rad" = 60, "fire" = 25, "acid" = 25, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/raider/combatduster
	...
	armor = list("melee" = 35, "bullet" = 55, "laser" = 35, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/exile
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 20, "bomb" = 40, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 20, "wound" = 10)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/f13/exile/legexile
	...
	armor = list("melee" = 55, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 40, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 20, "wound" = 10)
	icon_state = "legexile"
	item_state = "legexile"
...
/obj/item/clothing/suit/armor/f13/raider/raidercombat
	...
	armor = list("melee" = 40, "bullet" = 40 , "laser" = 40,"energy" = 25, "bomb" = 50, "bio" = 50, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/raider/raidermetal
	...
	armor = list("melee" = 65, "bullet" = 55, "laser" = 55, "energy" = 25, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/legion
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/recruit
	...
	armor = list("melee" = 50, "bullet" = 35, "laser" = 25, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
	slowdown = 0.04
...
/obj/item/clothing/suit/armor/f13/legion/recruit/decan
	...
	armor = list("melee" = 55, "bullet" = 40, "laser" = 25, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 20)
...
/obj/item/clothing/suit/armor/f13/legion/prime
	...
	armor = list("melee" = 55, "bullet" = 45, "laser" = 30, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/prime/decan
	...
	armor = list("melee" = 55, "bullet" = 45, "laser" = 30, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 25)
...
/obj/item/clothing/suit/armor/f13/legion/orator
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 35, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/vet
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 35, "energy" = 15, "bomb" = 30, "bio" = 5, "rad" = 5, "fire" = 35, "acid" = 0, "wound" = 10)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/heavy
	...
	armor = list("melee" = 55, "bullet" = 50, "laser" = 35, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 30)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/vet/explorer
	...
	armor = list("melee" = 40, "bullet" = 25, "laser" = 20, "energy" = 10, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/vet/vexil
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 42, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 30, "acid" = 0, "wound" = 30) //Must compete with HT so we will give it wound armor equivalent to the veteran decanus'
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/venator
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 15)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 5)
...
/obj/item/clothing/suit/armor/f13/legion/centurion //good all around
	...
	armor = list("melee" = 65, "bullet" = 55, "laser" = 40, "energy" = 25, "bomb" = 45, "bio" = 20, "rad" = 20, "fire" = 45, "acid" = 45, "wound" = 30)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/palacent //laser resist spec
	...
	armor = list("melee" = 65, "bullet" = 45, "laser" = 70, "energy" = 65, "bomb" = 55, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40) //almost SPA
	slowdown = 0.35
...
/obj/item/clothing/suit/armor/f13/legion/rangercent //speed and bullet resist, sacrifices all else
	...
	armor = list("melee" = 27.5, "bullet" = 62.5, "laser" = 25, "energy" = 15, "bomb" = 35, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 10)
	slowdown = 0.03
...
/obj/item/clothing/suit/armor/f13/legion/legate
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 70, "bullet" = 70, "laser" = 50, "energy" = 35, "bomb" = 45, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 50) //Admin spawn
...
/obj/item/clothing/suit/armor/f13/legion/vet/explorercanada
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 10)
	slowdown = 0.03
/*
...
/obj/item/clothing/suit/armor/f13/utilityvest/logisticsofficer //same as his beret
	...
	armor = list("melee" = 15, "bullet" = 50, "laser" = 30, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reserve
	...
	item_state = "ncr_infantry_vest"
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 25, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/conscript
	...
	armor = list("melee" = 25, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reinforced/engineer
	...
	armor = list("melee" = 35, "bullet" = 5, "laser" = 40, "energy" = 40, "bomb" = 85, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 45) //Melee boost in favor of ballistic removal from the bomb resistant stat
...
/obj/item/clothing/suit/armor/f13/ncrarmor/lieutenant
	...
	armor = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/ncr_dressjack
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 10)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/trailranger
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 5)
	slowdown = 0.03
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 4)
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood/senior
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 65, "energy" = 55, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/combat/mk2/remnant
	...
	icon_state = "remnant"
	item_state = "remnant"
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/combat/enclave
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 20, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
