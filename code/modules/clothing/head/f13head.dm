...
/obj/item/clothing/head/helmet/f13/combat/mk2
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 45, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 10)
...
/obj/item/clothing/head/helmet/f13/power_armor/t51b
	...
	armor = list("melee" = 75, "bullet" = 75, "laser" = 75, "energy" = 27, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 70)
	actions_types = list(/datum/action/item_action/toggle_helmet_light)
...
/obj/item/clothing/head/helmet/f13/power_armor/t60
	...
	armor = list("melee" = 85, "bullet" = 85, "laser" = 85, "energy" = 45, "bomb" = 82, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 50, "wound" = 80)
	actions_types = list(/datum/action/item_action/toggle_helmet_light)
...
/obj/item/clothing/head/helmet/f13/power_armor/midwest
	...
	icon = 'icons/mob/clothing/head.dmi'
	actions_types = list(/datum/action/item_action/toggle_helmet_light)
	armor = list("melee" = 75, "bullet" = 75, "laser" = 75, "energy" = 30, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 72)
...
/obj/item/clothing/head/helmet/f13/power_armor/midwest/hardened
	...
	icon = 'icons/mob/clothing/head.dmi'
	actions_types = list(/datum/action/item_action/toggle_helmet_light)
	armor = list("melee" = 80, "bullet" = 80, "laser" = 80, "energy" = 27, "bomb" = 64, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 75)
