...
/datum/techweb_node/medigax
	...
	design_ids = list("medigax_chassis", "medigax_torso", "medigax_head", "medigax_left_arm", "medigax_right_arm", "medigax_left_leg", "medigax_right_leg", "medigax_armor","gygax_main",
	"gygax_peri", "gygax_targ")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
/*
