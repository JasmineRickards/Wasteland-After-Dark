...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_BOS_CIVI = FREQ_BOS_CIV
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_BOS_CIV]" = RADIO_CHANNEL_BOS_CIVI
))

GLOBAL_LIST_INIT(accesstoradio, list(
		"[ACCESS_ENCLAVE]" = list(RADIO_CHANNEL_ENCLAVE),
		"[ACCESS_BOS]" = list(RADIO_CHANNEL_BOS, RADIO_CHANNEL_BOS_CIVI),
		"[ACCESS_BOS_CIVILIAN]" = list(RADIO_CHANNEL_BOS_CIVI),
